...
<div style="margin-top:20px;text-align:center;"><img src="{{BASE_URL}}/promo/owner.png" alt="Owner" width="200" style="display:block;max-width:100%;height:auto;margin:0 auto;border:0;border-radius:16px;box-shadow:0 12px 32px -8px rgba(0,0,0,0.15);" /><p style="margin:8px 0 0;font-size:13px;color:#166534;font-weight:600;">Owner</p></div>
