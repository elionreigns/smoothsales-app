...
const ELION_CONTACT_EMAIL = "elionreigns@gmail.com";
const LEGACY_CONTACT_EMAIL = "coralcrowntechnologies@gmail.com";
...
const ELION_PRESS_KIT_URL = "https://www.elionmusic.com/presskit/";
...
<p style="margin:0 0 10px;font-size:11px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;"><a href="${ELION_PRESS_KIT_URL}" style="color:#64748b;text-decoration:underline;">E Lion Music – Press kit</a></p>
<p style="margin:0;"><a href="${ELION_PRESS_KIT_URL}" style="display:inline-block;text-decoration:none;line-height:0;border-radius:16px;"><img src="https://www.coralcrownsolutions.com/promo/elionmusic-press-kit.jpg" alt="E Lion Music press kit – tap to open full press kit online" width="320" style="display:block;max-width:100%;height:auto;margin:0 auto;border:0;border-radius:16px;box-shadow:0 12px 32px -8px rgba(0,0,0,0.15);" /></a></p>
<p style="margin:12px 0 0;font-size:12px;color:#64748b;line-height:1.5;"><a href="${ELION_PRESS_KIT_URL}" style="color:#475569;font-weight:600;">elionmusic.com</a> · <a href="https://www.youtube.com/@elionreigns" style="color:#475569;font-weight:600;">YouTube @elionreigns</a></p>
</div>`;
const ELION_PRESS_KIT_TEXT = `\n\n— E Lion Music full press kit: ${ELION_PRESS_KIT_URL}\n— elionmusic.com · https://www.youtube.com/@elionreigns\n`;
const IMAGE_BASE_URL = "https://www.coralcrownsolutions.com";
...
function applyElionContactOverrides(
  id: TemplateId,
  content: { subject: string; html: string; text: string }
): { subject: string; html: string; text: string } {
  if (!isElionMusicTemplateId(id as string)) return content;
  return {
    subject: content.subject.replaceAll(LEGACY_CONTACT_EMAIL, ELION_CONTACT_EMAIL),
    html: content.html.replaceAll(LEGACY_CONTACT_EMAIL, ELION_CONTACT_EMAIL),
    text: content.text.replaceAll(LEGACY_CONTACT_EMAIL, ELION_CONTACT_EMAIL),
  };
}
...
<p style="margin:0;font-size:13px;color:#b91c1c;font-style:italic;">P.S. Door tickets &amp; merch – just ask. We want your night to run smooth.</p>
  ...
  "p48x-personal-v2": {
    subject: "P48X – Your mind on what's true & lovely (book, app, 24+ hr audiobook & member chatbots)",
    text: `Hi {{Name}},
...
Why it helps: What you think shapes who you become. P48X gives you a daily path to center your mind on what is true, honorable, pure, and lovely – and the companion app makes it practical. Connect your Google Calendar; the app creates special links that take you to your reflection page. Log in with Google, get a randomized prompt for the day, journal and reflect. There is also a full audiobook (over 24 hours) in the author's voice – read it, listen to it, or do both.

Audiobook – listen free: Full playlist (all chapters): https://www.youtube.com/watch?v=UP6Wp5cNk_Y&list=PLI_jj49IER90aR1Dlj0TrcRy2iJwyRWwt
Chapter 1 Purity: https://www.youtube.com/watch?v=7mGLVqKRmUI | Chapter 2 Truth: https://www.youtube.com/watch?v=57lTUDxnpfM | Chapter 3 Praiseworthy: https://www.youtube.com/watch?v=NK2cSyaCKyk | Chapter 4 Wholesome: https://www.youtube.com/watch?v=RWZtR9ipPBc | Chapter 5 Excellence: https://www.youtube.com/watch?v=k17EeydQn70 | Chapter 6 Admirable: https://www.youtube.com/watch?v=nAbG3co-21k | Chapter 7 Peace: https://www.youtube.com/watch?v=G3o-WxdoHmo | Chapter 8 Honorable: https://www.youtube.com/watch?v=iDX6mccfSUU | Chapter 9 Lovely: https://www.youtube.com/watch?v=o8_whmIBf3I | P48X Afterthoughts: https://www.youtube.com/watch?v=xJa5qTNStIM
To listen to the whole book (over 24 hours) and get member-only access, join my channel and become a member. Members also get access to custom biblically trained chatbots on Prayer Authority: the Urim & Thummim Chatbot (know God's will in any situation), the Dream Interpreter (interpret dreams biblically), the Spousal Translator (turns raw emotional words into loving, marriage-counseling-style language your spouse will want to respond to – from a husband's or wife's perspective), and the Biblical Counsel Chatbot (talk to 12 biblical advisors at once or one at a time). Dream Interpreter: https://prayerauthority.com/prayers/dreams.php | Spousal Translator: https://www.prayerauthority.com/translator/ | Urim & Thummim: https://www.prayerauthority.com/prayers/urim2.php | Biblical Counsel (12 counselors): https://www.prayerauthority.com/counsel/
...
We're here when you're ready.\nCoral Crown Solutions · coralcrowntechnologies@gmail.com · (808) 393-0153`,
    html: `<div style="font-family:Georgia,'Times New Roman',serif;max-width:600px;margin:0 auto;background-color:#fefce8;background-image:linear-gradient(180deg,#fefce8 0%,#fef9c3 100%);border:2px solid #ca8a04;border-radius:24px;overflow:hidden;box-shadow:0 20px 50px -15px rgba(202,138,4,0.25),0 10px 28px -8px rgba(0,0,0,0.1);color-scheme:light;">
...
<h1 style="margin:0;font-size:26px;font-weight:800;letter-spacing:-0.02em;line-height:1.2;">Your mind on what's true &amp; lovely</h1>
<p style="margin:14px 0 0;font-size:15px;opacity:0.95;">Book, app, 24+ hours of audiobook – plus member-only chatbots (Dream Interpreter, Spousal Translator, Urim &amp; Thummim, Biblical Counsel).</p>
</div>
<div style="padding:32px 28px;background-color:#fffbeb;color:#1c1917;-webkit-text-fill-color:#1c1917;text-align:center;">
<p style="margin:0 0 6px;font-size:11px;font-weight:700;letter-spacing:0.15em;color:#78350f;-webkit-text-fill-color:#78350f;text-transform:uppercase;">Hello</p>
<p style="margin:0 0 24px;font-size:18px;font-weight:600;line-height:1.4;border-bottom:2px solid #fde047;padding-bottom:16px;color:#1c1917;-webkit-text-fill-color:#1c1917;">Hi {{Name}},</p>
<p style="margin:0 0 26px;font-size:15px;line-height:1.7;color:#1c1917;-webkit-text-fill-color:#1c1917;">In a world that constantly shifts, <strong>P48X</strong> offers an unshakable foundation rooted in Philippians 4:8. Each chapter explores one of the virtues Paul exhorted us to meditate on – Purity, Truth, Praiseworthiness, Wholesomeness, Excellence, Admirable, Peace, Honor, and Lovely things – and how they manifest in the lives of those who walked with God.</p>
<p style="margin:28px 0 10px;font-size:11px;font-weight:700;letter-spacing:0.15em;color:#78350f;-webkit-text-fill-color:#78350f;text-transform:uppercase;">Why this book will help you</p>
<p style="margin:0 0 18px;font-size:14px;line-height:1.7;color:#1c1917;-webkit-text-fill-color:#1c1917;">What you think shapes who you become. Focusing your mind on what is <strong>true, honorable, pure, and lovely</strong> brings peace and clarity. P48X is both a deep read and a daily practice – and the <strong>free P48X app</strong> makes it practical: connect your Google Calendar, get special links to your reflection page, log in with Google, and receive a randomized prompt each day to journal and reflect. Plus a <strong>full audiobook (over 24 hours)</strong> in the author's voice – and for members, access to biblically trained chatbots.</p>
<p style="margin:0 0 10px;font-size:11px;font-weight:700;letter-spacing:0.15em;color:#78350f;-webkit-text-fill-color:#78350f;text-transform:uppercase;">Audiobook – over 24 hours in the author's voice</p>
<p style="margin:0 0 12px;font-size:14px;line-height:1.7;color:#1c1917;-webkit-text-fill-color:#1c1917;">Listen free: full playlist and every chapter linked below. To listen to the <strong>whole book</strong> (over 24 hours) and get <strong>member-only access</strong>, join my channel and become a member. Members also get custom codes for Prayer Authority's biblically trained chatbots: <strong>Urim &amp; Thummim</strong> (know God's will in any situation), <strong>Dream Interpreter</strong>, <strong>Spousal Translator</strong> (raw emotions → loving, marriage-counseling language your spouse will want to respond to), and <strong>Biblical Counsel</strong> (talk to 12 biblical advisors at once or one at a time).</p>
<p style="margin:0 0 8px;font-size:13px;color:#1c1917;-webkit-text-fill-color:#1c1917;"><strong>Full playlist:</strong> <a href="https://www.youtube.com/watch?v=UP6Wp5cNk_Y&list=PLI_jj49IER90aR1Dlj0TrcRy2iJwyRWwt" style="color:#92400e;">YouTube – P48X Audiobook (all chapters)</a></p>
<p style="margin:0 0 8px;font-size:12px;color:#1c1917;-webkit-text-fill-color:#1c1917;">Chapters: <a href="https://www.youtube.com/watch?v=7mGLVqKRmUI" style="color:#92400e;">1 Purity</a> · <a href="https://www.youtube.com/watch?v=57lTUDxnpfM" style="color:#92400e;">2 Truth</a> · <a href="https://www.youtube.com/watch?v=NK2cSyaCKyk" style="color:#92400e;">3 Praiseworthy</a> · <a href="https://www.youtube.com/watch?v=RWZtR9ipPBc" style="color:#92400e;">4 Wholesome</a> · <a href="https://www.youtube.com/watch?v=k17EeydQn70" style="color:#92400e;">5 Excellence</a> · <a href="https://www.youtube.com/watch?v=nAbG3co-21k" style="color:#92400e;">6 Admirable</a> · <a href="https://www.youtube.com/watch?v=G3o-WxdoHmo" style="color:#92400e;">7 Peace</a> · <a href="https://www.youtube.com/watch?v=iDX6mccfSUU" style="color:#92400e;">8 Honorable</a> · <a href="https://www.youtube.com/watch?v=o8_whmIBf3I" style="color:#92400e;">9 Lovely</a> · <a href="https://www.youtube.com/watch?v=xJa5qTNStIM" style="color:#92400e;">Afterthoughts</a></p>
<p style="margin:0 0 16px;font-size:12px;color:#1c1917;-webkit-text-fill-color:#1c1917;"><strong>Prayer Authority chatbots (members):</strong> <a href="https://prayerauthority.com/prayers/dreams.php" style="color:#92400e;">Dream Interpreter</a> · <a href="https://www.prayerauthority.com/translator/" style="color:#92400e;">Spousal Translator</a> · <a href="https://www.prayerauthority.com/prayers/urim2.php" style="color:#92400e;">Urim &amp; Thummim</a> · <a href="https://www.prayerauthority.com/counsel/" style="color:#92400e;">Biblical Counsel (12)</a></p>
<div style="background-color:#ffffff;color:#1c1917;-webkit-text-fill-color:#1c1917;border:2px solid #eab308;border-radius:18px;padding:24px 26px;margin:28px 0;box-shadow:0 4px 16px rgba(202,138,4,0.15);">
...
<p style="margin:0 0 12px;font-size:15px;color:#1c1917;-webkit-text-fill-color:#1c1917;line-height:1.55;"><strong>Get the book:</strong> <a href="https://www.barnesandnoble.com/w/p48x-eric-schaefer/1147510577?ean=2940181543621" style="color:#92400e;">Barnes &amp; Noble</a> · <a href="https://books.apple.com/us/book/p48x/id6746675717" style="color:#92400e;">Apple Books</a> · <a href="https://www.smashwords.com/books/view/1780908" style="color:#92400e;">Smashwords</a> · <a href="https://www.kobo.com/us/en/ebook/p48x" style="color:#92400e;">Rakuten Kobo</a></p>
<p style="margin:0 0 12px;font-size:15px;color:#1c1917;-webkit-text-fill-color:#1c1917;line-height:1.55;"><strong>Use the app:</strong> <a href="https://www.prayerauthority.com/prayers/p48x.php" style="color:#92400e;">P48X Reflections at Prayer Authority</a> – sign up with Google, set up daily prompts, journal and reflect.</p>
<p style="margin:0 0 10px;"><a href="https://www.youtube.com/watch?v=tvY4niTN4jA" style="display:inline-block;background:rgba(202,138,4,0.2);color:#78350f;border:2px solid #ca8a04;padding:14px 28px;text-decoration:none;border-radius:999px;font-weight:700;font-size:14px;">Watch: How to set up P48X with Google Calendar</a></p>
<p style="margin:0;font-size:13px;color:#451a03;-webkit-text-fill-color:#451a03;font-style:italic;">P.S. Join the channel as a member to hear the full 24+ hour audiobook and get access to the Urim &amp; Thummim, Dream Interpreter, Spousal Translator, and Biblical Counsel chatbots.</p>
</div>
</div>
</div>`,
  },
...
export function getTemplate(id: TemplateId): { subject: string; html: string; text: string } {
  const finalize = (payload: { subject: string; html: string; text: string }) => ({
    ...payload,
    // Safety net: ensure embedded promo images always resolve in inbox clients.
...
Biblically trained chatbots (try them): Dream Interpreter – interpret dreams with a custom-trained, Scripture-based AI: https://prayerauthority.com/prayers/dreams.php | Spousal Translator – turn raw emotional words into loving, marriage-counseling-style language your spouse will want to respond to: https://www.prayerauthority.com/translator/ | Urim & Thummim – seek God's will in any situation with a biblically grounded chatbot: https://www.prayerauthority.com/prayers/urim2.php | Biblical Counsel – talk to 12 biblical advisors (one or all) for wisdom and counsel: https://www.prayerauthority.com/counsel/
...
<p style="margin:0 0 10px;font-size:11px;font-weight:700;letter-spacing:0.15em;color:#92400e;text-transform:uppercase;">Biblically trained chatbots – try them free</p>
<p style="margin:0 0 8px;font-size:13px;color:#78350f;"><strong>Dream Interpreter</strong> – interpret dreams with a custom-trained, Scripture-based AI: <a href="https://prayerauthority.com/prayers/dreams.php" style="color:#b45309;">prayerauthority.com/prayers/dreams.php</a></p>
<p style="margin:0 0 8px;font-size:13px;color:#78350f;"><strong>Spousal Translator</strong> – turn raw emotional words into loving, marriage-counseling-style language your spouse will want to respond to: <a href="https://www.prayerauthority.com/translator/" style="color:#b45309;">prayerauthority.com/translator/</a></p>
<p style="margin:0 0 8px;font-size:13px;color:#78350f;"><strong>Urim &amp; Thummim</strong> – seek God's will in any situation with a biblically grounded chatbot: <a href="https://www.prayerauthority.com/prayers/urim2.php" style="color:#b45309;">prayerauthority.com/prayers/urim2.php</a></p>
<p style="margin:0 0 18px;font-size:13px;color:#78350f;"><strong>Biblical Counsel</strong> – talk to 12 biblical advisors (one or all) for wisdom and counsel: <a href="https://www.prayerauthority.com/counsel/" style="color:#b45309;">prayerauthority.com/counsel/</a></p>
...
<p style="margin:0 0 10px;font-size:11px;font-weight:700;letter-spacing:0.15em;color:#92400e;text-transform:uppercase;">Biblically trained chatbots – try them free</p>
<p style="margin:0 0 8px;font-size:13px;color:#78350f;"><strong>Dream Interpreter</strong>: <a href="https://prayerauthority.com/prayers/dreams.php" style="color:#b45309;">prayerauthority.com/prayers/dreams.php</a> · <strong>Spousal Translator</strong>: <a href="https://www.prayerauthority.com/translator/" style="color:#b45309;">prayerauthority.com/translator/</a> · <strong>Urim &amp; Thummim</strong>: <a href="https://www.prayerauthority.com/prayers/urim2.php" style="color:#b45309;">prayerauthority.com/prayers/urim2.php</a> · <strong>Biblical Counsel (12)</strong>: <a href="https://www.prayerauthority.com/counsel/" style="color:#b45309;">prayerauthority.com/counsel/</a></p>
<p style="margin:0 0 18px;font-size:12px;color:#78350f;">Custom-trained, Scripture-based tools for dream interpretation, marriage communication, discerning God's will, and biblical wisdom.</p>
...
<p style="margin:0;font-size:13px;color:#15803d;font-style:italic;">P.S. Your stage, his energy – ready when you have a slot.</p>
  ...
  "elion-levelup": {
    subject: "E Lion – A&R / Industry pitch: 100+ songs, Family Feud winner, Hawaii → global (festivals, label, collabs)",
    text: `Hi {{Name}},

I'm E Lion – a Messianic rapper from Hawaii with 100+ songs out, Family Feud grand prize (2016), and a family I'm supporting with music (married, kid on the way). I'm reaching out because I want to do more: get funding to record in the studio, promote what I've got, get signed, work with major artists, get paid to perform at festivals, and break into a legit circuit. Hawaii's talent pool for management and promotion is slim; I want to expand globally and I'm looking for a hand.

Stats & links: An estimated 115–145 million viewers saw my Family Feud grand prize run (2016 – first Hawaiian family to win 5 in a row). 10M+ YouTube views, 1,000+ performances, 30K+ CDs sold hand-to-hand – see the zoomable mosaic and promo model testimonials at https://www.elionmusic.com/mosaic. Music on every major platform. I've been told I look like Justin Bieber more times than I can count; I'm super skilled at rapping and want to branch into other genres. I have a video guy in Hawaii and make new music all the time, including AI music (lyrics I write). Music videos: Judah's Tribe https://www.youtube.com/watch?v=8MfXAAdALAA | Eye of the Storm (AI) https://www.youtube.com/watch?v=2kDvBNKly5s.

Streaming: Spotify https://open.spotify.com/artist/2S3rAhbq65ECikmOW1k2EA | Apple Music https://music.apple.com/us/artist/e-lion/1111804063 | Pandora (E Lion) https://www.pandora.com/artist/e-lion/AR9vZJllkt3JmVq | Amazon Music https://www.amazon.com/music/player/artists/B01GOGAW4W/e-lion | TikTok https://www.tiktok.com/@elionreigns | SoundCloud https://soundcloud.com/elionrapmusic | Deezer https://www.deezer.com/us/artist/354652062 | iHeartRadio https://www.iheart.com/artist/e-lion-46608091/ | Full catalog https://www.elionmusic.com/rap/
...
Interviews & press: Bored City Interview https://www.elionmusic.com/articles/bored-city-interview-e-lion | Spotlight Interview https://www.elionmusic.com/articles/spotlight-interview-e-lion | TBK247 Island Roots https://www.elionmusic.com/articles/tbk247-island-roots-faith-healing-music | Zoho CRM https://www.elionmusic.com/articles/running-multiple-businesses-crm | Fatal House Fire https://www.elionmusic.com/articles/elion-fatal-house-fire | 93.9 The Beat https://www.elionmusic.com/articles/elion-radio-939 | 102.7 Radio https://www.elionmusic.com/articles/elion-radio-1027 | KHON2 Hurricane Iselle https://www.elionmusic.com/articles/hurricane-iselle-sale-day | PopCandies TV https://www.elionmusic.com/articles/popcandies-hollywood-club | E Lion Wiki https://www.elionmusic.com/wiki/ | Learn More About Lions https://www.elionmusic.com/lions | elionmusic.com https://www.elionmusic.com

I'm looking for: funding to record, promotion for existing releases, a record deal or distribution, collaborations with major artists, paid festival and concert slots, and management or mentorship to move forward. Whatever you can do – a reply, a call, or a next step – I'm ready.

elionmusic.com | coralcrowntechnologies@gmail.com | (808) 393-0153`,
    html: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#f5f3ff;border:2px solid #7c3aed;border-radius:24px;overflow:hidden;box-shadow:0 20px 50px -15px rgba(124,58,237,0.28),0 10px 28px -8px rgba(0,0,0,0.1);">
<div style="background:linear-gradient(145deg,#7c3aed 0%,#5b21b6 50%,#4c1d95 100%);color:#fff;padding:32px 28px;border-bottom:4px solid #a78bfa;text-shadow:0 1px 2px rgba(0,0,0,0.2);text-align:center;">
<p style="margin:0 0 8px;font-size:11px;font-weight:700;letter-spacing:0.2em;text-transform:uppercase;opacity:0.9;">E Lion Music – A&R / Level Up</p>
<h1 style="margin:0;font-size:24px;font-weight:800;letter-spacing:-0.03em;line-height:1.2;">100+ songs. Family Feud winner. Hawaii → global.</h1>
<p style="margin:14px 0 0;font-size:14px;opacity:0.95;">Festivals, label, collabs, paid performances – I'm reaching out for a hand.</p>
</div>
...
<p style="margin:0 0 16px;font-size:15px;line-height:1.7;">I'm <strong>E Lion</strong> – a Messianic rapper from Hawaii. I won <strong>Family Feud's grand prize in 2016</strong> (first Hawaiian family to win 5 in a row – an estimated 115–145M viewers saw the run). I'm married with a family (and a kid on the way) I'm trying to support with music, and I've got <strong>100+ songs</strong> out. I'm living in Hawaii but I want to get out – I'm working on millions of streams, making AI music (lyrics I write), and I need help: <strong>funding to record in the studio</strong>, <strong>promotion</strong> for what I've got, <strong>getting signed</strong>, <strong>working with major artists</strong>, <strong>paid festival and concert slots</strong>, and getting into a legit circuit. Hawaii's talent pool for management and promotion is very low – I want to expand globally and I'm reaching out to see what you can do.</p>
...
<p style="margin:0 0 12px;font-size:14px;line-height:1.65;"><strong>10M+ YouTube views</strong> · <strong>1,000+ performances</strong> · <strong>30K+ CDs sold</strong> hand-to-hand (zoomable mosaic + promo model testimonials at <a href="https://www.elionmusic.com/mosaic" style="color:#6d28d9;">elionmusic.com/mosaic</a>). I've been told I look like Justin Bieber more times than I can count; I'm super skilled at rapping and want to branch into other genres. I have a video guy in Hawaii and make new music all the time.</p>
...
<p style="margin:0 0 12px;font-size:14px;line-height:1.6;"><a href="https://open.spotify.com/artist/2S3rAhbq65ECikmOW1k2EA" style="color:#6d28d9;">Spotify</a> · <a href="https://music.apple.com/us/artist/e-lion/1111804063" style="color:#6d28d9;">Apple Music</a> · <a href="https://www.pandora.com/artist/e-lion/AR9vZJllkt3JmVq" style="color:#6d28d9;">Pandora (E Lion)</a> · <a href="https://www.amazon.com/music/player/artists/B01GOGAW4W/e-lion" style="color:#6d28d9;">Amazon Music</a> · <a href="https://www.tiktok.com/@elionreigns" style="color:#6d28d9;">TikTok</a> · <a href="https://soundcloud.com/elionrapmusic" style="color:#6d28d9;">SoundCloud</a> · <a href="https://www.deezer.com/us/artist/354652062" style="color:#6d28d9;">Deezer</a> · <a href="https://www.iheart.com/artist/e-lion-46608091/" style="color:#6d28d9;">iHeartRadio</a> · <a href="https://www.elionmusic.com/rap/" style="color:#6d28d9;">Full catalog</a></p>
<p style="margin:18px 0 10px;font-size:11px;font-weight:700;letter-spacing:0.12em;color:#6d28d9;text-transform:uppercase;">Music videos</p>
<p style="margin:0 0 12px;font-size:14px;line-height:1.6;"><a href="https://www.youtube.com/watch?v=8MfXAAdALAA" style="color:#6d28d9;">Judah's Tribe</a> · <a href="https://www.youtube.com/watch?v=2kDvBNKly5s" style="color:#6d28d9;">Eye of the Storm (AI – lyrics by me)</a></p>
...
<p style="margin:0 0 10px;font-size:15px;color:#4c1d95;line-height:1.55;"><strong>What I'm looking for:</strong> Funding to record · Promotion for existing releases · Record deal or distribution · Collaborations with major artists · Paid festival &amp; concert slots · Management or mentorship. I have a video guy in Hawaii and make new music all the time – I just need a hand moving forward to all I can be.</p>
...
Quick update: Today I’m releasing and serving as E Lion with 100+ songs out on major platforms on my own. My P48X book is live (audiobook too), and I released my memoir preview “Christ, My Best Friend” on YouTube while I prepare the official rollout. Years ago I performed with The Highway Band; what you’d book now is E Lion solo with this full catalog.
...
- Apple Music: https://music.apple.com/us/artist/e-lion/1111804063
- Pandora: https://www.pandora.com/station/play/193699866101160467
- Family Feud compilation: https://www.youtube.com/watch?v=_zEtolAmKmI
- Throwback (Highway Band era): HebrewFest https://www.youtube.com/watch?v=zz0oX6FIcPU&t=22s
- Throwback: Campfire after HebrewFest https://www.youtube.com/watch?v=GbOQlyGjh04
- Christ, My Best Friend (memoir preview): https://www.youtube.com/watch?v=bi8JI4A4lcY

Israel appearances (highlights):
- LIVE in Jerusalem (Old City): https://www.youtube.com/watch?v=7vYZRiulzHo
- Leonardo Club in Tiberias: https://www.youtube.com/watch?v=4lKsLd9D11k&t=16s
- LIVE in Tel Aviv (Mike’s Place): https://www.youtube.com/watch?v=sN67fJEhhOI&t=7s
- Snow Ball Dream (Jerusalem): https://www.youtube.com/watch?v=H1ue2MCDGmg
- Peace in the Middle East: https://www.youtube.com/watch?v=g6GB_KzQZII
- Abraham: https://www.youtube.com/watch?v=I6QTXH1-ffc
- LIVE at Elli’s (Haifa): https://www.youtube.com/watch?v=ci_NsMejsYM
- Windows Freestyle (Jerusalem): https://www.youtube.com/watch?v=0RwB6cXkJ-A
- Shaloha from Jerusalem: https://www.youtube.com/watch?v=urBRI8N9z-Q
- Adios en el Ciqar: https://www.youtube.com/watch?v=JB6fgkBmt_8
...
H.O.P.E. = Hospitals · Orphanages · Prisons · Elderly homes — a simple rhythm of showing up for the overlooked, one weekend at a time.
https://www.prayerauthority.com/hope/
Hospital freestyle video: https://www.youtube.com/watch?v=lRd5l_xwPnM

Encouragement I’m passing along: Joshua 8:1 — "Do not be afraid; do not be discouraged." I’d be grateful if you’d pray, connect, and share these tools with anyone who needs them.
...
I am sending this because I would love to speak at your event about my book P48X, perform new music, share my testimony, and walk your people through the spiritual tech tools and community I built at PrayerAuthority.com. Hawaii is a small place and this would mean a lot to me. If you are not the right contact, would you please refer me to someone on the mainland who brings in paid speakers for faith-based events?
...
Quick-share links for your following:
- Quick social post (X): https://twitter.com/intent/tweet?text=Check%20out%20Eric%20Hans%20Schaefer%27s%20new%20book%20P48X%2C%20the%20audiobook%2C%20and%20Prayer%20Authority%20tools%20for%20believers.%20Book%3A%20https%3A%2F%2Fbooks.apple.com%2Fus%2Fbook%2Fp48x%2Fid6746675717%20Audiobook%3A%20https%3A%2F%2Fbooks.apple.com%2Fus%2Faudiobook%2Fp48x-extreme-spiritual-fitness-your-guide-to-complete%2Fid1885081198%3Fuo%3D4%20Join%3A%20https%3A%2F%2Fwww.prayerauthority.com%2Fprayers%2Fregister.php
- Quick social post (Facebook): https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.prayerauthority.com%2Fprayers%2Fregister.php

Below the share buttons (HTML email shows screenshots):
- Prayer Authority Home Page: https://www.prayerauthority.com/
- SOAP Community Journal: https://www.prayerauthority.com/journal/
- Pandora (nearly 10k monthly listeners): https://www.pandora.com/station/play/193699866101160467
- YouTube — all releases (playlist): https://www.youtube.com/playlist?list=OLAK5uy_m0vsiscmOx4zis5TVf72yCTOD7hTJA010
- Music video (Judah’s Tribe): https://www.youtube.com/watch?v=8MfXAAdALAA
...
<h1 style="margin:0;font-size:24px;font-weight:900;letter-spacing:-0.02em;line-height:1.25;">Leadership Brief: P48X, PrayerAuthority, HOPE Weekends, and event partnership options</h1>
<p style="margin:12px 0 0;font-size:14px;opacity:0.95;">A professional overview for pastors and organizational leaders.</p>
</div>
<div style="padding:26px 24px;color:#0f172a;line-height:1.65;font-size:14px;">
<p style="margin:0 0 14px;">Hi {{Name}},</p>
<p style="margin:0 0 14px;">I’m reaching out with a ministry update as <strong>Eric Hans Schaefer (E Lion)</strong>. Today I’m releasing and serving under the <strong>E Lion</strong> name with <strong>100+ songs</strong> out on major platforms on my own—the <strong>P48X</strong> book (and audiobook), plus a growing suite of Prayer Authority tools that help believers build a real devotional life. (Years ago I performed with <strong>The Highway Band</strong>; what you’ll book now is <strong>E Lion</strong> as a solo artist with this full catalog.)</p>
...
<p style="margin:0 0 12px;text-align:center;line-height:1.9;">
<a href="https://books.apple.com/us/book/p48x/id6746675717" style="display:inline-block;background:#1d4ed8;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Apple Books</a>
<a href="https://www.barnesandnoble.com/w/p48x-eric-schaefer/1147510577?ean=2940181543621" style="display:inline-block;background:#2563eb;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Barnes &amp; Noble</a>
<a href="https://www.smashwords.com/books/view/1780908" style="display:inline-block;background:#1e40af;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Smashwords</a>
<a href="https://www.kobo.com/us/en/ebook/p48x" style="display:inline-block;background:#0f172a;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Kobo eBook</a>
</p>
...
<p style="margin:0 0 12px;text-align:center;line-height:1.9;">
<a href="https://www.kobo.com/us/en/audiobook/p48x-extreme-spiritual-fitness?sId=cc5e8a83-bdfa-48d0-ab84-3060a079e42b&ssId=jkhyG7sQSLoPfjDtXgmYj&cPos=1" style="display:inline-block;background:#1d4ed8;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Kobo audiobook</a>
<a href="https://www.storytel.com/tv/books/p48x-extreme-spiritual-fitness-your-guide-to-complete-spiritual-health-13769448" style="display:inline-block;background:#1e40af;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Storytel</a>
...
<p style="margin:0 0 6px;font-size:11px;font-weight:900;letter-spacing:0.18em;text-transform:uppercase;color:#1e40af;">Why E Lion?</p>
...
<p style="margin:0 0 12px;text-align:center;"><a href="https://www.youtube.com/watch?v=bi8JI4A4lcY" style="display:inline-block;background:#1d4ed8;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;">Christ, My Best Friend</a> <span style="font-size:13px;color:#475569;">(memoir preview)</span></p>
<p style="margin:0 0 12px;font-size:11px;font-weight:700;letter-spacing:0.12em;color:#1d4ed8;text-transform:uppercase;">Israel appearances (highlights)</p>
<p style="margin:0 0 10px;font-size:14px;line-height:1.7;">
<a href="https://www.youtube.com/watch?v=7vYZRiulzHo" style="display:inline-block;background:#1d4ed8;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:800;font-size:12px;margin:0 6px 8px 0;">LIVE in Jerusalem (Old City)</a><br/>
<a href="https://www.youtube.com/watch?v=4lKsLd9D11k&t=16s" style="display:inline-block;background:#1d4ed8;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:800;font-size:12px;margin:0 6px 8px 0;">Leonardo Club in Tiberias</a><br/>
<a href="https://www.youtube.com/watch?v=sN67fJEhhOI&t=7s" style="display:inline-block;background:#1d4ed8;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:800;font-size:12px;margin:0 6px 8px 0;">LIVE in Tel Aviv (Mike’s Place)</a>
</p>
<p style="margin:0 0 10px;font-size:14px;line-height:1.7;">
<a href="https://www.youtube.com/watch?v=H1ue2MCDGmg" style="display:inline-block;background:#1d4ed8;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:800;font-size:12px;margin:0 6px 8px 0;">Snow Ball Dream (Jerusalem)</a><br/>
<a href="https://www.youtube.com/watch?v=g6GB_KzQZII" style="display:inline-block;background:#1d4ed8;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:800;font-size:12px;margin:0 6px 8px 0;">Peace in the Middle East</a><br/>
<a href="https://www.youtube.com/watch?v=I6QTXH1-ffc" style="display:inline-block;background:#1d4ed8;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:800;font-size:12px;margin:0 6px 8px 0;">Abraham</a>
</p>
<p style="margin:0 0 12px;font-size:14px;line-height:1.7;">
<a href="https://www.youtube.com/watch?v=ci_NsMejsYM" style="display:inline-block;background:#1d4ed8;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:800;font-size:12px;margin:0 6px 8px 0;">LIVE at Elli’s (Haifa)</a><br/>
...
<p style="margin:0 0 12px;text-align:center;line-height:1.9;">Games: <a href="https://www.prayerauthority.com/prayers/games/davidvsgoliath/" style="display:inline-block;background:#1d4ed8;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">David vs Goliath</a> <a href="https://prayerauthority.com/prayers/games/davidvsgoliath/level2/index.html" style="display:inline-block;background:#1d4ed8;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Sequel</a></p>
<p style="margin:0 0 10px;font-size:11px;font-weight:700;letter-spacing:0.12em;color:#1d4ed8;text-transform:uppercase;">SOAP Journal (for groups &amp; gatherings)</p>
<p style="margin:0 0 12px;font-size:14px;line-height:1.7;">The <strong>SOAP Journal</strong> on Prayer Authority walks people through <strong>Scripture, Observation, Application, and Prayer</strong>—a repeatable rhythm anyone can use at home. As a leader, you can point your small groups, Sunday classes, or men’s/women’s gatherings to one shared passage for the week, ask everyone to complete a SOAP entry before you meet, and use those reflections as natural discussion starters—no extra curriculum required.</p>
<p style="margin:0 0 12px;text-align:center;"><a href="https://www.prayerauthority.com/journal/" style="display:inline-block;background:#1d4ed8;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;">SOAP Journal</a></p>
<p style="margin:0 0 10px;font-size:11px;font-weight:700;letter-spacing:0.12em;color:#1d4ed8;text-transform:uppercase;">HOPE Weekends (love with your shoes on)</p>
<p style="margin:0 0 12px;font-size:14px;line-height:1.7;">I’ve been encouraging believers to adopt a simple rhythm called <strong>H.O.P.E.</strong>: <strong>Hospitals · Orphanages · Prisons · Elderly homes</strong>. It isn’t “a program with a clipboard”—it’s a sustainable commitment to show up, face-to-face, for people who feel forgotten.</p>
<p style="margin:0 0 12px;font-size:14px;line-height:1.7;"><strong>How your church can participate:</strong> mention HOPE from the platform and in your bulletin or app; pick one pillar per month (or quarter) and coordinate a small team; connect existing mercy ministries to the same language so stories compound; partner with another congregation to cover more ground; and start with one visit everyone can picture—then build a monthly rhythm your people can sustain.</p>
<p style="margin:0 0 12px;line-height:1.8;text-align:center;"><a href="https://www.prayerauthority.com/hope/" style="display:inline-block;background:#1d4ed8;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">HOPE Weekends</a> <a href="https://www.youtube.com/watch?v=lRd5l_xwPnM" style="display:inline-block;background:#1d4ed8;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Hospital freestyle</a></p>
<p style="margin:0 0 14px;line-height:1.7;">If you’re leading a church, school, or organization: what would it look like to invite your people into one measurable act of mercy per week—something sustainable that builds faith, courage, and community?</p>
<p style="margin:0 0 16px;line-height:1.7;">Thank you for reading. A verse I’m leaning on (Joshua 8:1): <strong>“Do not be afraid; do not be discouraged.”</strong></p>
...
<p style="margin:0 0 12px;">From the press kit, I can bring a <strong>full concert experience</strong> (1 hour+ of original music with short speaking moments), a <strong>conference keynote/testimony</strong> (15–45 minutes with music woven throughout), or <strong>collaboration/features</strong>. I can also bring a <strong>P48X table</strong>, run a <strong>PrayerAuthority QR sign-up</strong>, and do a short <strong>live demo</strong> so people leave with tools—prayer rhythms, journals, and next steps.</p>
...
<p style="margin:0 0 14px;font-size:14px;line-height:1.7;">I am sending this because I would love to speak at your event about my book P48X, perform new music, share my testimony, and walk your people through the spiritual tech tools and community I built at PrayerAuthority.com. Hawaii is a small place and this would mean a lot to me. If you are not the right contact, would you please refer me to someone on the mainland who brings in paid speakers for faith-based events?</p>
...
<p style="margin:0 0 14px;"><a href="https://www.prayerauthority.com/" style="display:block;text-decoration:none;line-height:0;border-radius:14px;"><img src="https://www.coralcrownsolutions.com/promo/elion-story-5.png" alt="Prayer Authority home page" width="560" style="display:block;max-width:100%;height:auto;border-radius:14px;border:1px solid #bfdbfe;margin:0 auto;" /></a></p>
<p style="margin:0 0 10px;font-size:11px;font-weight:700;letter-spacing:0.12em;color:#1d4ed8;text-transform:uppercase;">SOAP Community Journal</p>
<p style="margin:0 0 14px;"><a href="https://www.prayerauthority.com/journal/" style="display:block;text-decoration:none;line-height:0;border-radius:14px;"><img src="https://www.coralcrownsolutions.com/promo/elion-story-8.png" alt="SOAP Community Journal on Prayer Authority" width="560" style="display:block;max-width:100%;height:auto;border-radius:14px;border:1px solid #bfdbfe;margin:0 auto;" /></a></p>
<p style="margin:0 0 10px;font-size:11px;font-weight:700;letter-spacing:0.12em;color:#1d4ed8;text-transform:uppercase;">Nearly 10k Monthly Listeners on Pandora</p>
<p style="margin:0 0 14px;"><a href="https://www.pandora.com/station/play/193699866101160467" style="display:block;text-decoration:none;line-height:0;border-radius:14px;"><img src="https://www.coralcrownsolutions.com/promo/elion-story-11.png" alt="E Lion on Pandora" width="560" style="display:block;max-width:100%;height:auto;border-radius:14px;border:1px solid #bfdbfe;margin:0 auto;" /></a></p>
<p style="margin:0 0 10px;font-size:14px;line-height:1.65;">Here’s my music on YouTube—full releases playlist and a recent video:</p>
<p style="margin:0 0 14px;text-align:center;line-height:1.9;"><a href="https://www.youtube.com/playlist?list=OLAK5uy_m0vsiscmOx4zis5TVf72yCTOD7hTJA010" style="display:inline-block;background:#dc2626;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 4px 8px 0;">YouTube: all releases</a> <a href="https://www.youtube.com/watch?v=8MfXAAdALAA" style="display:inline-block;background:#b91c1c;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 4px 8px 0;">Music video: Judah’s Tribe</a></p>
<p style="margin:0 0 14px;text-align:center;"><a href="https://www.prayerauthority.com/prayers/register.php" style="display:inline-block;background:linear-gradient(145deg,#1d4ed8 0%,#1e40af 100%);color:#fff;padding:10px 18px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;">Prayer Authority</a></p>
<p style="margin:0;text-align:center;font-size:13px;color:#334155;line-height:1.7;">Eric Hans Schaefer (E Lion)<br/><a href="https://www.elionmusic.com" style="display:inline-block;background:#1d4ed8;color:#fff;padding:8px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:8px 4px 0 0;">elionmusic.com</a> <a href="mailto:elionreigns@gmail.com" style="display:inline-block;background:#1d4ed8;color:#fff;padding:8px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:8px 4px 0 0;">Email</a><br/><span style="font-size:13px;">(808) 393-0153</span></p>
</div>
</div>`,
  },
  "elion-laymen": {
...
I've now got 100+ songs out on major platforms as E Lion on my own, my P48X book is published, and the audiobook is out too. I also uploaded "Christ, My Best Friend" (my memoir) on YouTube for now while I finish the wider release. Years ago I played HebrewFest and a campfire set with The Highway Band (throwback clips in the HTML); today I’m releasing and performing as E Lion with this catalog, and I’ve been sharing older Israel-era footage too.
...
- Song promos: https://www.elionmusic.com/promo/
- Spotify: https://open.spotify.com/artist/2S3rAhbq65ECikmOW1k2EA
- Apple Music artist page: https://music.apple.com/us/artist/e-lion/1111804063
- Pandora: https://www.pandora.com/station/play/193699866101160467
- Family Feud compilation: https://www.youtube.com/watch?v=_zEtolAmKmI
- Christ, My Best Friend (memoir preview): https://www.youtube.com/watch?v=bi8JI4A4lcY
- Throwback (Highway Band era): HebrewFest https://www.youtube.com/watch?v=zz0oX6FIcPU&t=22s
...
<p style="margin:0 0 14px;">Hi {{Name}},</p>
<p style="margin:0 0 14px;">Quick life update: I now have <strong>100+ songs</strong> out as <strong>E Lion</strong> on my own, the <strong>P48X book</strong> is published, the <strong>P48X audiobook</strong> is out, and I posted my memoir preview <strong>Christ, My Best Friend</strong> on YouTube. I’ve also been building tools on PrayerAuthority for believers who want to grow stronger in Scripture, prayer, and practical daily faith. (The HebrewFest clips below are a <strong>throwback</strong> to when I played with <strong>The Highway Band</strong>—that was years ago; today it’s me as E Lion with this catalog.)</p>
...
<p style="margin:0 0 8px;text-align:center;line-height:1.9;">
<a href="https://books.apple.com/us/book/p48x/id6746675717" style="display:inline-block;background:#c2410c;color:#fff;padding:10px 16px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Buy P48X</a>
<a href="https://books.apple.com/us/audiobook/p48x-extreme-spiritual-fitness-your-guide-to-complete/id1885081198?uo=4" style="display:inline-block;background:#7c2d12;color:#fff;padding:10px 16px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Get audiobook</a>
</p>
...
<a href="https://www.elionmusic.com/player/" style="display:inline-block;background:#c2410c;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Player</a>
<a href="https://www.elionmusic.com/promo/" style="display:inline-block;background:#ea580c;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Song promos</a>
</p>
<p style="margin:0 0 12px;">
...
<p style="margin:0 0 6px;font-size:13px;color:#7c2d12;">Throwback (Highway Band era):</p>
<p style="margin:0 0 12px;text-align:center;line-height:1.9;">
<a href="https://www.youtube.com/watch?v=zz0oX6FIcPU&t=22s" style="display:inline-block;background:#c2410c;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">HebrewFest</a>
<a href="https://www.youtube.com/watch?v=GbOQlyGjh04" style="display:inline-block;background:#7c2d12;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Campfire after show</a>
</p>
...
<p style="margin:0 0 12px;text-align:center;"><a href="https://www.youtube.com/watch?v=tvY4niTN4jA" style="display:inline-block;background:rgba(234,88,12,0.15);color:#9a3412;border:2px solid #ea580c;padding:10px 18px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;">Watch: How to set up P48X with Google Calendar</a></p>
...
<a href="https://www.prayerauthority.com/prophecy/" style="display:inline-block;background:#7c2d12;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Prophetic timeline</a>
<a href="https://www.prayerauthority.com/journal/" style="display:inline-block;background:#c2410c;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">SOAP Journal</a>
<a href="https://www.prayerauthority.com/prayers/urim2.php" style="display:inline-block;background:#ea580c;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Urim &amp; Thummim</a>
<a href="https://www.prayerauthority.com/belief/" style="display:inline-block;background:#b45309;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Belief Window</a>
<a href="https://www.prayerauthority.com/vitamins/" style="display:inline-block;background:#92400e;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Spiritual Vitamins</a>
<a href="https://www.prayerauthority.com/battlesword/" style="display:inline-block;background:#78350f;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Battle Sword</a>
...
<p style="margin:0 0 12px;"><a href="https://www.elionmusic.com/presskit/" style="display:block;text-decoration:none;line-height:0;border-radius:14px;"><img src="https://www.coralcrownsolutions.com/promo/elionmusic-press-kit.jpg" alt="E Lion Music press kit image" width="560" style="display:block;max-width:100%;height:auto;border-radius:14px;border:1px solid #fed7aa;margin:0 auto;" /></a></p>
<p style="margin:0 0 6px;font-size:11px;font-weight:900;letter-spacing:0.12em;text-transform:uppercase;color:#c2410c;">My sister Amber and baby Blair</p>
<p style="margin:0 0 12px;"><a href="https://www.youtube.com/watch?v=32Ky2qZkmnw" style="display:block;text-decoration:none;line-height:0;border-radius:14px;"><img src="https://www.coralcrownsolutions.com/promo/elion-story-2.png" alt="Amber and baby Blair" width="560" style="display:block;max-width:100%;height:auto;border-radius:14px;border:1px solid #fed7aa;margin:0 auto;" /></a></p>
<p style="margin:0 0 6px;font-size:11px;font-weight:900;letter-spacing:0.12em;text-transform:uppercase;color:#c2410c;">Ashley and I and my Corgi Stella</p>
<p style="margin:0 0 12px;"><a href="https://www.elionmusic.com/" style="display:block;text-decoration:none;line-height:0;border-radius:14px;"><img src="https://www.coralcrownsolutions.com/promo/elion-story-3.png" alt="Ashley, Eric, and Stella the corgi" width="560" style="display:block;max-width:100%;height:auto;border-radius:14px;border:1px solid #fed7aa;margin:0 auto;" /></a></p>
<p style="margin:0 0 6px;font-size:11px;font-weight:900;letter-spacing:0.12em;text-transform:uppercase;color:#c2410c;">Marriage at Magic Island with Ashley and my immediate family</p>
<p style="margin:0 0 12px;"><a href="https://www.elionmusic.com/presskit/" style="display:block;text-decoration:none;line-height:0;border-radius:14px;"><img src="https://www.coralcrownsolutions.com/promo/elion-story-4.png" alt="Wedding photo at Magic Island with family" width="560" style="display:block;max-width:100%;height:auto;border-radius:14px;border:1px solid #fed7aa;margin:0 auto;" /></a></p>
<p style="margin:0 0 6px;font-size:11px;font-weight:900;letter-spacing:0.12em;text-transform:uppercase;color:#c2410c;">Prayer Authority (website)</p>
<p style="margin:0 0 12px;"><a href="https://www.prayerauthority.com/" style="display:block;text-decoration:none;line-height:0;border-radius:14px;"><img src="https://www.coralcrownsolutions.com/promo/elion-story-5.png" alt="Prayer Authority website screenshot" width="560" style="display:block;max-width:100%;height:auto;border-radius:14px;border:1px solid #fed7aa;margin:0 auto;" /></a></p>
<p style="margin:0 0 6px;font-size:11px;font-weight:900;letter-spacing:0.12em;text-transform:uppercase;color:#c2410c;">Local news before we flew out for Family Feud</p>
<p style="margin:0 0 12px;"><a href="https://www.youtube.com/watch?v=_zEtolAmKmI" style="display:block;text-decoration:none;line-height:0;border-radius:14px;"><img src="https://www.coralcrownsolutions.com/promo/elion-story-6.png" alt="Local news feature before Family Feud" width="560" style="display:block;max-width:100%;height:auto;border-radius:14px;border:1px solid #fed7aa;margin:0 auto;" /></a></p>
<p style="margin:0 0 6px;font-size:11px;font-weight:900;letter-spacing:0.12em;text-transform:uppercase;color:#c2410c;">Family winning Family Feud’s grand prize</p>
<p style="margin:0 0 12px;"><a href="https://www.youtube.com/watch?v=_zEtolAmKmI" style="display:block;text-decoration:none;line-height:0;border-radius:14px;"><img src="https://www.coralcrownsolutions.com/promo/elion-story-7.png" alt="Family Feud grand prize win" width="560" style="display:block;max-width:100%;height:auto;border-radius:14px;border:1px solid #fed7aa;margin:0 auto;" /></a></p>
<p style="margin:0 0 6px;font-size:11px;font-weight:900;letter-spacing:0.12em;text-transform:uppercase;color:#c2410c;">SOAP Journal (try it)</p>
<p style="margin:0 0 12px;"><a href="https://www.prayerauthority.com/journal/" style="display:block;text-decoration:none;line-height:0;border-radius:14px;"><img src="https://www.coralcrownsolutions.com/promo/elion-story-8.png" alt="SOAP Journal on Prayer Authority" width="560" style="display:block;max-width:100%;height:auto;border-radius:14px;border:1px solid #fed7aa;margin:0 auto;" /></a></p>
<p style="margin:0 0 6px;font-size:11px;font-weight:900;letter-spacing:0.12em;text-transform:uppercase;color:#c2410c;">David vs Goliath (game I built)</p>
<p style="margin:0 0 12px;"><a href="https://www.prayerauthority.com/prayers/games/davidvsgoliath/" style="display:block;text-decoration:none;line-height:0;border-radius:14px;"><img src="https://www.coralcrownsolutions.com/promo/elion-story-9.png" alt="David vs Goliath game" width="560" style="display:block;max-width:100%;height:auto;border-radius:14px;border:1px solid #fed7aa;margin:0 auto;" /></a></p>
<p style="margin:0 0 6px;font-size:11px;font-weight:900;letter-spacing:0.12em;text-transform:uppercase;color:#c2410c;">Spotify (E Lion)</p>
<p style="margin:0 0 12px;"><a href="https://open.spotify.com/artist/2S3rAhbq65ECikmOW1k2EA" style="display:block;text-decoration:none;line-height:0;border-radius:14px;"><img src="https://www.coralcrownsolutions.com/promo/elion-story-10.png" alt="E Lion on Spotify" width="560" style="display:block;max-width:100%;height:auto;border-radius:14px;border:1px solid #fed7aa;margin:0 auto;" /></a></p>
<p style="margin:0 0 6px;font-size:11px;font-weight:900;letter-spacing:0.12em;text-transform:uppercase;color:#c2410c;">Nearly 10k Monthly Listeners on Pandora</p>
<p style="margin:0 0 12px;"><a href="https://www.pandora.com/station/play/193699866101160467" style="display:block;text-decoration:none;line-height:0;border-radius:14px;"><img src="https://www.coralcrownsolutions.com/promo/elion-story-11.png" alt="E Lion Pandora channel screenshot" width="560" style="display:block;max-width:100%;height:auto;border-radius:14px;border:1px solid #fed7aa;margin:0 auto;" /></a></p>
<p style="margin:0 0 12px;text-align:center;line-height:1.9;"><a href="https://books.apple.com/us/book/p48x/id6746675717" style="display:inline-block;background:#c2410c;color:#fff;padding:10px 16px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 4px 8px 0;">Buy P48X</a> <a href="https://books.apple.com/us/audiobook/p48x-extreme-spiritual-fitness-your-guide-to-complete/id1885081198?uo=4" style="display:inline-block;background:#7c2d12;color:#fff;padding:10px 16px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 4px 8px 0;">Audiobook</a></p>
<p style="margin:0 0 12px;text-align:center;line-height:1.9;"><a href="https://open.spotify.com/artist/2S3rAhbq65ECikmOW1k2EA" style="display:inline-block;background:#166534;color:#fff;padding:10px 16px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 4px 8px 0;">Spotify</a> <a href="https://music.apple.com/us/artist/e-lion/1111804063" style="display:inline-block;background:#be185d;color:#fff;padding:10px 16px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 4px 8px 0;">Apple Music</a></p>
<p style="margin:0 0 14px;text-align:center;"><a href="https://www.prayerauthority.com/prayers/register.php" style="display:inline-block;background:linear-gradient(145deg,#ea580c 0%,#c2410c 100%);color:#fff;padding:10px 18px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;">Prayer Authority</a></p>
<p style="margin:0;text-align:center;font-size:13px;color:#7c2d12;line-height:1.7;">E Lion (Eric Hans Schaefer)<br/><a href="https://www.elionmusic.com" style="display:inline-block;background:#1d4ed8;color:#fff;padding:8px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:8px 4px 0 0;">elionmusic.com</a> <a href="mailto:elionreigns@gmail.com" style="display:inline-block;background:#7c2d12;color:#fff;padding:8px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:8px 4px 0 0;">elionreigns@gmail.com</a><br/><span style="font-size:13px;">(808) 393-0153</span></p>
</div>
</div>`,
  },
  "elion-products-programs": {
...
<p style="margin:0 0 20px;"><a href="https://www.elionmusic.com" style="display:inline-block;background:rgba(8,145,178,0.12);color:#0e7490;border:2px solid #0891b2;padding:12px 24px;text-decoration:none;border-radius:999px;font-weight:700;font-size:14px;">elionmusic.com</a></p>
  ...
  "elion-record-label-mainstream": {
    subject: "E Lion – 100+ songs live, Family Feud 115M+ saw, full catalog on YouTube – ready to talk (808) 393-0153",
    text: `Hi {{Name}},

I'm E Lion – an artist from Hawaii with 100+ songs on every major network (Spotify, Apple Music, Amazon, TikTok, Pandora, SoundCloud, Deezer, iHeart). Some tracks use AI production (Suno) but I write every lyric. I won Family Feud's grand prize in 2016 – first Hawaiian family to win 5 in a row – and an estimated 115–145 million people saw that run. I'm looking for a record label or partner to help me move forward in my music career: funding to record in proper studios, travel and perform at festivals and conferences, and get out of Hawaii into a real performing circuit.

Stats: 10M+ YouTube views, 1,000+ performances, 30K+ CDs sold hand-to-hand. I've been told I look like Justin Bieber; I can rap and want to branch into other genres. I have a video guy and make new music constantly. Watch Behind the Scenes of Shine (my music video): https://www.youtube.com/watch?v=4Qqs7JSOHmA
...
YouTube – my full released catalog (DistroKid & Landr): Playlist of all released songs https://www.youtube.com/playlist?list=OLAK5uy_m0vsiscmOx4zis5TVf72yCTOD7hTJA010 | All releases https://www.youtube.com/@elionreigns/releases

Music videos: Judah's Tribe (latest) https://www.youtube.com/watch?v=8MfXAAdALAA | Instead of 8 Mile this is the 808 Mile https://www.youtube.com/watch?v=KJmQ6O87Szw | Eye of the Storm (AI) https://www.youtube.com/watch?v=2kDvBNKly5s | Behind the Scenes of Shine https://www.youtube.com/watch?v=4Qqs7JSOHmA

My ask: I'm looking for funding to record, a record deal or distribution, collaborations, paid festival and conference slots, and management – so I can move forward in my career and get out of Hawaii into a performing circuit. If you're interested in talking about music and what's possible, call me: (808) 393-0153. I'm ready to talk.
...
<p style="margin:0 0 16px;font-size:15px;line-height:1.7;">I'm <strong>E Lion</strong> – an artist from Hawaii with <strong>100+ songs on every major platform</strong> and a <strong>full YouTube catalog</strong> (DistroKid &amp; Landr). I write every lyric; some production uses Suno. I won <strong>Family Feud's grand prize</strong> (2016 – first Hawaiian family to win 5 in a row); <strong>115–145 million people</strong> saw that run. I'm ready to move forward: <strong>funding to record in proper studios</strong>, <strong>travel and festivals</strong>, and <strong>get out of Hawaii into a real performing circuit</strong>. If you're open to a conversation, <strong>call me: (808) 393-0153</strong> – I answer.</p>
...
<p style="margin:18px 0 10px;font-size:11px;font-weight:700;letter-spacing:0.12em;color:#b45309;text-transform:uppercase;">YouTube – full catalog &amp; videos</p>
<p style="margin:0 0 10px;font-size:14px;line-height:1.6;"><strong>All my released songs</strong> (DistroKid &amp; Landr): <a href="https://www.youtube.com/playlist?list=OLAK5uy_m0vsiscmOx4zis5TVf72yCTOD7hTJA010" style="color:#b45309;">Playlist – every release</a> · <a href="https://www.youtube.com/@elionreigns/releases" style="color:#b45309;">YouTube Releases</a></p>
<p style="margin:0 0 14px;font-size:14px;line-height:1.6;"><strong>Music videos:</strong> <a href="https://www.youtube.com/watch?v=8MfXAAdALAA" style="color:#b45309;">Judah's Tribe</a> (latest) · <a href="https://www.youtube.com/watch?v=KJmQ6O87Szw" style="color:#b45309;">Instead of 8 Mile this is the 808 Mile</a> · <a href="https://www.youtube.com/watch?v=4Qqs7JSOHmA" style="color:#b45309;">Behind the Scenes of Shine</a></p>
<p style="margin:18px 0 10px;font-size:11px;font-weight:700;letter-spacing:0.12em;color:#b45309;text-transform:uppercase;">Watch first: Behind the Scenes of Shine</p>
<p style="margin:0 0 14px;font-size:14px;line-height:1.6;">Behind the scenes of my music video <strong>Shine</strong>: <a href="https://www.youtube.com/watch?v=4Qqs7JSOHmA" style="color:#b45309;">YouTube – Behind the Scenes of Shine</a></p>
...
<p style="margin:0 0 12px;font-size:15px;color:#78350f;line-height:1.55;"><strong>My ask:</strong> Funding to record in proper studios · Travel &amp; perform at festivals and conferences · Record deal or distribution · Collaborations with major artists · Management – so I can move forward in my music career and get out of Hawaii into a real performing circuit.</p>
<p style="margin:16px 0 14px;font-size:16px;color:#78350f;line-height:1.5;"><strong>If you're interested in talking about music and how I can move forward – call me:</strong></p>
<p style="margin:0 0 16px;"><a href="tel:+18083930153" style="display:inline-block;background:linear-gradient(145deg,#d97706 0%,#b45309 100%);color:#fff;padding:16px 32px;text-decoration:none;border-radius:999px;font-weight:700;font-size:18px;">(808) 393-0153</a></p>
<p style="margin:0 0 8px;"><a href="https://www.youtube.com/playlist?list=OLAK5uy_m0vsiscmOx4zis5TVf72yCTOD7hTJA010" style="display:inline-block;background:rgba(217,119,6,0.2);color:#b45309;border:2px solid #d97706;padding:10px 20px;text-decoration:none;border-radius:999px;font-weight:700;font-size:13px;">YouTube: Full playlist (DistroKid &amp; Landr)</a></p>
<p style="margin:8px 0 8px;"><a href="https://www.youtube.com/watch?v=8MfXAAdALAA" style="display:inline-block;background:rgba(217,119,6,0.2);color:#b45309;border:2px solid #d97706;padding:10px 20px;text-decoration:none;border-radius:999px;font-weight:700;font-size:13px;">Judah's Tribe (latest video)</a> <a href="https://www.youtube.com/watch?v=KJmQ6O87Szw" style="display:inline-block;background:rgba(217,119,6,0.2);color:#b45309;border:2px solid #d97706;padding:10px 20px;text-decoration:none;border-radius:999px;font-weight:700;font-size:13px;">808 Mile</a></p>
<p style="margin:0 0 10px;"><a href="https://www.youtube.com/watch?v=4Qqs7JSOHmA" style="display:inline-block;background:rgba(217,119,6,0.2);color:#b45309;border:2px solid #d97706;padding:12px 24px;text-decoration:none;border-radius:999px;font-weight:700;font-size:14px;">Watch: Behind the Scenes of Shine</a></p>
<p style="margin:12px 0 10px;"><a href="https://www.elionmusic.com" style="display:inline-block;background:linear-gradient(145deg,#d97706 0%,#b45309 100%);color:#fff;padding:14px 28px;text-decoration:none;border-radius:999px;font-weight:700;font-size:14px;">elionmusic.com</a></p>
<p style="margin:0;font-size:13px;color:#b45309;">coralcrowntechnologies@gmail.com · (808) 393-0153</p>
</div>
</div>
</div>`,
  },
  "elion-record-label-christian": {
    subject: "E Lion – Holy Hip-Hop from Hawaii: 100+ songs, Family Feud 115M+ saw, world tour vision – call me (808) 393-0153",
    text: `Hi {{Name}},
...
Music videos & live: Judah's Tribe https://www.youtube.com/watch?v=8MfXAAdALAA | HebrewFest Experience – my Entrust video and me performing at HebrewFest with the band The Highway https://www.youtube.com/watch?v=zz0oX6FIcPU&t=22s | Eye of the Storm (AI) https://www.youtube.com/watch?v=2kDvBNKly5s | 2012 World Tour video https://www.youtube.com/watch?v=2ZqlEh2ye4g
...
<div style="padding:28px 26px;color:#4c1d95;">
<p style="margin:0 0 6px;font-size:11px;font-weight:700;letter-spacing:0.15em;color:#6d28d9;text-transform:uppercase;">Hi {{Name}},</p>
<p style="margin:0 0 16px;font-size:15px;line-height:1.7;">I'm <strong>E Lion</strong> – Holy Hip-Hop from Hawaii with <strong>100+ songs on every major platform</strong> and a <strong>full YouTube catalog</strong> (DistroKid &amp; Landr). I write every lyric. I won <strong>Family Feud's grand prize</strong> (2016 – 115M+ saw); I have a <strong>2012 world tour video</strong> I'd like to see come to pass. I'm ready for a <strong>Christian record label</strong> or partner: funding to record, travel, festivals, and get out of Hawaii. <strong>Call me: (808) 393-0153</strong> – I answer and I'm ready to talk.</p>
<p style="margin:18px 0 10px;font-size:11px;font-weight:700;letter-spacing:0.12em;color:#6d28d9;text-transform:uppercase;">YouTube – full catalog &amp; videos</p>
<p style="margin:0 0 10px;font-size:14px;line-height:1.6;"><strong>All my released songs</strong> (DistroKid &amp; Landr): <a href="https://www.youtube.com/playlist?list=OLAK5uy_m0vsiscmOx4zis5TVf72yCTOD7hTJA010" style="color:#6d28d9;">Playlist – every release</a> · <a href="https://www.youtube.com/@elionreigns/releases" style="color:#6d28d9;">YouTube Releases</a></p>
<p style="margin:0 0 14px;font-size:14px;line-height:1.6;"><strong>Watch:</strong> <a href="https://www.youtube.com/watch?v=8MfXAAdALAA" style="color:#6d28d9;">Judah's Tribe</a> · <a href="https://www.youtube.com/watch?v=zz0oX6FIcPU&t=22s" style="color:#6d28d9;">HebrewFest Experience</a> – my Entrust video and me performing at HebrewFest with the band The Highway · <a href="https://www.youtube.com/watch?v=2ZqlEh2ye4g" style="color:#6d28d9;">2012 World Tour video</a></p>
...
<p style="margin:12px 0 8px;"><a href="https://www.youtube.com/playlist?list=OLAK5uy_m0vsiscmOx4zis5TVf72yCTOD7hTJA010" style="display:inline-block;background:rgba(124,58,237,0.2);color:#6d28d9;border:2px solid #7c3aed;padding:10px 20px;text-decoration:none;border-radius:999px;font-weight:700;font-size:13px;">YouTube: Full playlist (DistroKid &amp; Landr)</a></p>
<p style="margin:0 0 8px;"><a href="https://www.youtube.com/watch?v=8MfXAAdALAA" style="display:inline-block;background:rgba(124,58,237,0.2);color:#6d28d9;border:2px solid #7c3aed;padding:10px 20px;text-decoration:none;border-radius:999px;font-weight:700;font-size:13px;">Judah's Tribe</a> <a href="https://www.youtube.com/watch?v=zz0oX6FIcPU&t=22s" style="display:inline-block;background:rgba(124,58,237,0.2);color:#6d28d9;border:2px solid #7c3aed;padding:10px 20px;text-decoration:none;border-radius:999px;font-weight:700;font-size:13px;">HebrewFest Experience</a></p>
<p style="margin:0 0 10px;"><a href="https://www.youtube.com/watch?v=2ZqlEh2ye4g" style="display:inline-block;background:rgba(124,58,237,0.2);color:#6d28d9;border:2px solid #7c3aed;padding:12px 24px;text-decoration:none;border-radius:999px;font-weight:700;font-size:14px;">Watch: 2012 World Tour video</a></p>
<p style="margin:16px 0 10px;"><a href="https://www.elionmusic.com" style="display:inline-block;background:linear-gradient(145deg,#7c3aed 0%,#5b21b6 100%);color:#fff;padding:14px 28px;text-decoration:none;border-radius:999px;font-weight:700;font-size:14px;">elionmusic.com</a></p>
<p style="margin:0 0 10px;"><a href="https://www.elionmusic.com/lions" style="display:inline-block;background:rgba(124,58,237,0.2);color:#6d28d9;border:2px solid #7c3aed;padding:12px 24px;text-decoration:none;border-radius:999px;font-weight:700;font-size:14px;">Learn More About Lions</a></p>
...
Why it helps: What you think shapes who you become. P48X gives you a daily path to center your mind on what is true, honorable, pure, and lovely – and the companion app makes it practical. Connect your Google Calendar; the app creates special links that take you to your reflection page. Log in with Google, get a randomized prompt for the day, journal and reflect. There is also a full audiobook (over 24 hours) in the author's voice on Kobo, Storytel, and Apple Books—read it, listen to it, or do both.

Audiobook (full book, 24+ hours):
- Kobo: https://www.kobo.com/us/en/audiobook/p48x-extreme-spiritual-fitness?sId=cc5e8a83-bdfa-48d0-ab84-3060a079e42b&ssId=jkhyG7sQSLoPfjDtXgmYj&cPos=1
- Storytel: https://www.storytel.com/tv/books/p48x-extreme-spiritual-fitness-your-guide-to-complete-spiritual-health-13769448
- Apple Books audiobook: https://books.apple.com/us/audiobook/p48x-extreme-spiritual-fitness-your-guide-to-complete/id1885081198?uo=4

Free intro chapter (YouTube): https://www.youtube.com/watch?v=UP6Wp5cNk_Y

Channel members also get access to custom biblically trained chatbots on Prayer Authority: the Urim & Thummim Chatbot (know God's will in any situation), the Dream Interpreter (interpret dreams biblically), the Spousal Translator (turns raw emotional words into loving, marriage-counseling-style language your spouse will want to respond to – from a husband's or wife's perspective), and the Biblical Counsel Chatbot (talk to 12 biblical advisors at once or one at a time). Dream Interpreter: https://prayerauthority.com/prayers/dreams.php | Spousal Translator: https://www.prayerauthority.com/translator/ | Urim & Thummim: https://www.prayerauthority.com/prayers/urim2.php | Biblical Counsel (12 counselors): https://www.prayerauthority.com/counsel/

Where to get the ebook: Barnes & Noble, Apple Books, Smashwords, Rakuten Kobo. Sign up for the free P48X app (daily reflections, journal) at Prayer Authority – use your Google account.
...
<p style="margin:14px 0 0;font-size:15px;opacity:0.95;">Book, interactive app, and 24+ hours of audiobook in the author's voice – plus member-only chatbots.</p>
</div>
<div style="padding:32px 28px;background-color:#fffbeb;color:#1c1917;-webkit-text-fill-color:#1c1917;text-align:center;">
<p style="margin:0 0 6px;font-size:11px;font-weight:700;letter-spacing:0.15em;color:#78350f;-webkit-text-fill-color:#78350f;text-transform:uppercase;">Hello</p>
<p style="margin:0 0 24px;font-size:18px;font-weight:600;line-height:1.4;border-bottom:2px solid #fde047;padding-bottom:16px;color:#1c1917;-webkit-text-fill-color:#1c1917;">Hi {{Name}},</p>
...
<p style="margin:0 0 10px;font-size:11px;font-weight:700;letter-spacing:0.15em;color:#78350f;-webkit-text-fill-color:#78350f;text-transform:uppercase;">P48X book</p>
<p style="margin:0 0 18px;"><a href="https://www.prayerauthority.com/prayers/p48x.php" style="display:block;text-decoration:none;line-height:0;border-radius:14px;"><img src="https://www.coralcrownsolutions.com/promo/p48x-cover.png" alt="P48X by Eric Hans Schaefer book cover" width="560" style="display:block;max-width:100%;height:auto;border-radius:14px;border:2px solid #eab308;margin:0 auto;" /></a></p>
<p style="margin:0 0 10px;font-size:11px;font-weight:700;letter-spacing:0.15em;color:#78350f;-webkit-text-fill-color:#78350f;text-transform:uppercase;">Audiobook – 24+ hours in the author's voice</p>
<p style="margin:0 0 12px;font-size:14px;line-height:1.7;color:#1c1917;-webkit-text-fill-color:#1c1917;">Get the <strong>full audiobook</strong> on <strong>Kobo</strong>, <strong>Storytel</strong>, or <strong>Apple Books</strong>. Prefer a preview first? Watch the <strong>free intro chapter</strong> on YouTube (link below). <strong>Channel members</strong> also receive custom codes for Prayer Authority's biblically trained chatbots: <strong>Urim &amp; Thummim</strong>, <strong>Dream Interpreter</strong>, <strong>Spousal Translator</strong>, and <strong>Biblical Counsel</strong> (12 advisors).</p>
<p style="margin:0 0 10px;text-align:center;line-height:1.9;"><a href="https://www.kobo.com/us/en/audiobook/p48x-extreme-spiritual-fitness?sId=cc5e8a83-bdfa-48d0-ab84-3060a079e42b&ssId=jkhyG7sQSLoPfjDtXgmYj&cPos=1" style="display:inline-block;background:#1d4ed8;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Kobo audiobook</a> <a href="https://www.storytel.com/tv/books/p48x-extreme-spiritual-fitness-your-guide-to-complete-spiritual-health-13769448" style="display:inline-block;background:#1e40af;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Storytel</a> <a href="https://books.apple.com/us/audiobook/p48x-extreme-spiritual-fitness-your-guide-to-complete/id1885081198?uo=4" style="display:inline-block;background:#0f172a;color:#fff;padding:10px 14px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 6px 8px 0;">Apple Books audiobook</a></p>
<p style="margin:0 0 16px;text-align:center;line-height:1.9;"><a href="https://www.youtube.com/watch?v=UP6Wp5cNk_Y" style="display:inline-block;background:#b45309;color:#fff;padding:10px 16px;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;margin:0 4px 8px 0;">Intro chapter on YouTube</a></p>
<p style="margin:0 0 16px;font-size:12px;color:#1c1917;-webkit-text-fill-color:#1c1917;"><strong>Prayer Authority chatbots (members):</strong> <a href="https://prayerauthority.com/prayers/dreams.php" style="color:#92400e;">Dream Interpreter</a> · <a href="https://www.prayerauthority.com/translator/" style="color:#92400e;">Spousal Translator</a> · <a href="https://www.prayerauthority.com/prayers/urim2.php" style="color:#92400e;">Urim &amp; Thummim</a> · <a href="https://www.prayerauthority.com/counsel/" style="color:#92400e;">Biblical Counsel (12)</a></p>
<div style="background-color:#ffffff;color:#1c1917;-webkit-text-fill-color:#1c1917;border:2px solid #eab308;border-radius:18px;padding:24px 26px;margin:28px 0;box-shadow:0 4px 16px rgba(202,138,4,0.15);">
<p style="margin:0 0 10px;"><a href="https://www.prayerauthority.com/prayers/p48x.php" style="display:inline-block;background:linear-gradient(145deg,#a16207 0%,#854d0e 100%);color:#fff;padding:16px 32px;text-decoration:none;border-radius:999px;font-weight:700;font-size:15px;box-shadow:0 8px 24px -4px rgba(202,138,4,0.4);">P48X page – book &amp; app</a></p>
<p style="margin:0 0 12px;font-size:15px;color:#1c1917;-webkit-text-fill-color:#1c1917;line-height:1.55;"><strong>Get the book:</strong> <a href="https://www.barnesandnoble.com/w/p48x-eric-schaefer/1147510577?ean=2940181543621" style="color:#92400e;">Barnes &amp; Noble</a> · <a href="https://books.apple.com/us/book/p48x/id6746675717" style="color:#92400e;">Apple Books</a> · <a href="https://www.smashwords.com/books/view/1780908" style="color:#92400e;">Smashwords</a> · <a href="https://www.kobo.com/us/en/ebook/p48x" style="color:#92400e;">Rakuten Kobo</a></p>
...
<p style="margin:0 0 12px;font-size:15px;color:#1c1917;-webkit-text-fill-color:#1c1917;line-height:1.55;"><strong>Use the app:</strong> <a href="https://www.prayerauthority.com/prayers/p48x.php" style="color:#92400e;">P48X Reflections at Prayer Authority</a> – sign up with Google, set up daily prompts, journal and reflect.</p>
<p style="margin:0 0 10px;"><a href="https://www.youtube.com/watch?v=tvY4niTN4jA" style="display:inline-block;background:rgba(202,138,4,0.2);color:#78350f;border:2px solid #ca8a04;padding:14px 28px;text-decoration:none;border-radius:999px;font-weight:700;font-size:14px;">Watch: How to set up P48X with Google Calendar</a></p>
<p style="margin:0;font-size:13px;color:#451a03;-webkit-text-fill-color:#451a03;font-style:italic;">P.S. Get the full 24+ hour audiobook on Kobo, Storytel, or Apple Books. Join the channel as a member for custom codes to the Urim &amp; Thummim, Dream Interpreter, Spousal Translator, and Biblical Counsel chatbots.</p>
</div>
</div>
</div>`,
  },
...
<p style="margin:0 0 6px;font-size:11px;font-weight:700;letter-spacing:0.15em;color:#78350f;-webkit-text-fill-color:#78350f;text-transform:uppercase;">Hello</p>
<p style="margin:0 0 24px;font-size:18px;font-weight:600;line-height:1.4;border-bottom:2px solid #fde047;padding-bottom:16px;color:#1c1917;-webkit-text-fill-color:#1c1917;">Hi {{Name}},</p>
<p style="margin:0 0 26px;font-size:15px;line-height:1.7;color:#1c1917;-webkit-text-fill-color:#1c1917;">We're reaching out to <strong>physical distributors and retail stores</strong> who may want to carry <strong>P48X – Philippians 4:8 Expounded</strong>. You can order printed copies wholesale and mark up the book to sell in your store. Ideal for faith-based retailers, churches, and inspirational book sections.</p>
<p style="margin:28px 0 10px;font-size:11px;font-weight:700;letter-spacing:0.15em;color:#78350f;-webkit-text-fill-color:#78350f;text-transform:uppercase;">About the author</p>
<p style="margin:0 0 18px;font-size:14px;line-height:1.7;color:#1c1917;-webkit-text-fill-color:#1c1917;">Eric Schaefer is also <strong>E Lion</strong> – Holy Hip-Hop artist from Hawaii, <strong>Family Feud grand prize winner</strong> (2016 – first Hawaiian family to win 5 consecutive episodes), founder of Prayer Authority, and author of P48X. His music and brand at <a href="https://www.elionmusic.com" style="color:#92400e;">elionmusic.com</a> share the same heart for faith, excellence, and reaching people – so your customers who know E Lion or Family Feud will recognize the name.</p>
<p style="margin:0 0 10px;font-size:14px;line-height:1.6;color:#1c1917;-webkit-text-fill-color:#1c1917;"><a href="https://www.prayerauthority.com/prayers/p48x.php" style="color:#92400e;">P48X page – book &amp; app</a> · <a href="https://www.elionmusic.com/articles/hawaii-family-wins-grand-prize" style="color:#92400e;">Family Feud: Grand Prize article</a></p>
<div style="background-color:#ffffff;color:#1c1917;-webkit-text-fill-color:#1c1917;border:2px solid #eab308;border-radius:18px;padding:24px 26px;margin:28px 0;">
<p style="margin:0 0 14px;font-size:15px;color:#1c1917;-webkit-text-fill-color:#1c1917;line-height:1.55;"><strong>Next step:</strong> If you're interested in wholesale orders for your store, reply to this email and we'll send pricing, minimums, and order details. We typically respond within 24–48 hours.</p>
<p style="margin:0;font-size:13px;color:#451a03;-webkit-text-fill-color:#451a03;">Coral Crown Solutions | <a href="mailto:coralcrowntechnologies@gmail.com" style="color:#92400e;">Email us</a> | (808) 393-0153</p>
</div>
</div>
</div>`,
  },
...
<tr><td style="padding:6px 10px;border:1px solid #86efac;">Loose leaf rough cut or milled (kilo / lb)</td><td style="padding:6px 10px;border:1px solid #86efac;">$225 / $145</td><td style="padding:6px 10px;border:1px solid #86efac;">$315 / $203</td></tr>
<tr><td style="padding:6px 10px;border:1px solid #86efac;">2.8% loose leaf (kilo / lb)</td><td style="padding:6px 10px;border:1px solid #86efac;">$545 / $325</td><td style="padding:6px 10px;border:1px solid #86efac;">$763 / $455</td></tr>
<tr><td style="padding:6px 10px;border:1px solid #86efac;">Resin / Channa Budder (25g–10 kg)</td><td style="padding:6px 10px;border:1px solid #86efac;">$15/g–$1.45/g</td><td style="padding:6px 10px;border:1px solid #86efac;">$21/g–$2.03/g</td></tr>
<tr><td style="padding:6px 10px;border:1px solid #86efac;">2.5%–8.6% white / beige / high-alkaloid extracts</td><td style="padding:6px 10px;border:1px solid #86efac;">From $165–$995</td><td style="padding:6px 10px;border:1px solid #86efac;">From $231–$1,393</td></tr>
<tr><td style="padding:6px 10px;border:1px solid #86efac;">Nasal sprays (regular / 2x)</td><td style="padding:6px 10px;border:1px solid #86efac;">$12.50 / $17.50</td><td style="padding:6px 10px;border:1px solid #86efac;">$17.50 / $24.50</td></tr>
<tr><td style="padding:6px 10px;border:1px solid #86efac;">Kanna vape juice (herb / extract infused L)</td><td style="padding:6px 10px;border:1px solid #86efac;">$95 / $525</td><td style="padding:6px 10px;border:1px solid #86efac;">$133 / $735</td></tr>
...
<tr><td style="padding:6px 10px;border:1px solid #86efac;">Flower (lb / kilo; 5–100 kg tiered)</td><td style="padding:6px 10px;border:1px solid #86efac;">$60 / $99; from $95–$80/kg</td><td style="padding:6px 10px;border:1px solid #86efac;">$84 / $139; from $133–$112/kg</td></tr>
<tr><td style="padding:6px 10px;border:1px solid #86efac;">Powdered extract (kilo / lb / 250g / 100g)</td><td style="padding:6px 10px;border:1px solid #86efac;">$275 / $190 / $135 / $95</td><td style="padding:6px 10px;border:1px solid #86efac;">$385 / $266 / $189 / $133</td></tr>
<tr><td style="padding:6px 10px;border:1px solid #86efac;">Resin extract</td><td style="padding:6px 10px;border:1px solid #86efac;">$379.99/kg–$100/100g</td><td style="padding:6px 10px;border:1px solid #86efac;">$532/kg–$140/100g</td></tr>
<tr><td style="padding:6px 10px;border:1px solid #86efac;">Refined high potency extract</td><td style="padding:6px 10px;border:1px solid #86efac;">$2,995/kg–$75/10g</td><td style="padding:6px 10px;border:1px solid #86efac;">$4,193/kg–$105/10g</td></tr>
<tr><td style="padding:6px 10px;border:1px solid #86efac;">Vape juice (gallon / ½ gal); medium/high potency ½ gal</td><td style="padding:6px 10px;border:1px solid #86efac;">$225 / $145; $575 / $975</td><td style="padding:6px 10px;border:1px solid #86efac;">$315 / $203; $805 / $1,365</td></tr>
<tr><td style="padding:6px 10px;border:1px solid #86efac;">Liquid extract 20% (gal–100 gal)</td><td style="padding:6px 10px;border:1px solid #86efac;">$325–$250/gal</td><td style="padding:6px 10px;border:1px solid #86efac;">$455–$350/gal</td></tr>
<tr><td style="padding:6px 10px;border:1px solid #86efac;">White Lotus flower / extract; Red Lotus; 98% Nuciferine</td><td style="padding:6px 10px;border:1px solid #86efac;">From $70–$545</td><td style="padding:6px 10px;border:1px solid #86efac;">From $98–$763</td></tr>
...
<tr><td style="padding:6px 10px;border:1px solid #86efac;">81% / 70% freebase extract (100g / kg)</td><td style="padding:6px 10px;border:1px solid #86efac;">$750–$3,895; $575–$3,400</td><td style="padding:6px 10px;border:1px solid #86efac;">$1,050–$5,453; $805–$4,760</td></tr>
<tr><td style="padding:6px 10px;border:1px solid #86efac;">70% salt base (kg)</td><td style="padding:6px 10px;border:1px solid #86efac;">$4,200</td><td style="padding:6px 10px;border:1px solid #86efac;">$5,880</td></tr>
...
<tr><td style="padding:6px 10px;border:1px solid #86efac;">7-OH extract; 7-OH tablets 20mg (50–1000)</td><td style="padding:6px 10px;border:1px solid #86efac;">Inquire; $195–$1,150</td><td style="padding:6px 10px;border:1px solid #86efac;">Inquire; $273–$1,610</td></tr>
...
<tr><td style="padding:6px 10px;border:1px solid #86efac;">85% / 70% kavalactone paste (kg / lb / 250g / 100g)</td><td style="padding:6px 10px;border:1px solid #86efac;">$1,645–$325; $1,385–$275</td><td style="padding:6px 10px;border:1px solid #86efac;">$2,303–$455; $1,939–$385</td></tr>
<tr><td style="padding:6px 10px;border:1px solid #86efac;">Potent extract powder; instant 11.4% / heady 6.4% / body 6.6%</td><td style="padding:6px 10px;border:1px solid #86efac;">$515/kg–$105; $499–$195</td><td style="padding:6px 10px;border:1px solid #86efac;">$721/kg–$147; $699–$273</td></tr>
<tr><td style="padding:6px 10px;border:1px solid #86efac;">Micronized; medium grind (Fiji, Vanuatu, Tonga, Waka)</td><td style="padding:6px 10px;border:1px solid #86efac;">$135/lb–$225/kg; $90–$100/kg</td><td style="padding:6px 10px;border:1px solid #86efac;">$189/lb–$315/kg; $126–$140/kg</td></tr>
<tr><td style="padding:6px 10px;border:1px solid #86efac;">Liquid extract 5% (gal–100 gal); leaf per kg</td><td style="padding:6px 10px;border:1px solid #86efac;">$325–$250/gal; $185–$135</td><td style="padding:6px 10px;border:1px solid #86efac;">$455–$350/gal; $259–$189</td></tr>
...
<tr><td style="padding:6px 10px;border:1px solid #86efac;">Pantherina; Premium Closed Caps; Regalis; Grade A/B</td><td style="padding:6px 10px;border:1px solid #86efac;">$250–$1,295; $375–$1,050; $225–$775; $115–$250</td><td style="padding:6px 10px;border:1px solid #86efac;">$350–$1,813; $525–$1,470; $315–$1,085; $161–$350</td></tr>
<tr><td style="padding:6px 10px;border:1px solid #86efac;">Tincture 1L; extract (lb / kg)</td><td style="padding:6px 10px;border:1px solid #86efac;">$425; $1,500 / $2,350</td><td style="padding:6px 10px;border:1px solid #86efac;">$595; $2,100 / $3,290</td></tr>
...
<tr><td style="padding:6px 10px;border:1px solid #86efac;">Akuamma seed / extract powder / resin (low/high potency)</td><td style="padding:6px 10px;border:1px solid #86efac;">$45–$2,600/kg</td><td style="padding:6px 10px;border:1px solid #86efac;">$63–$3,640/kg</td></tr>
<tr><td style="padding:6px 10px;border:1px solid #86efac;">Mimosa Hostilis; Mad honey; African dream bean; Wild dagga</td><td style="padding:6px 10px;border:1px solid #86efac;">$275/kg; $275; $275; $195</td><td style="padding:6px 10px;border:1px solid #86efac;">$385/kg; $385; $385; $273</td></tr>
