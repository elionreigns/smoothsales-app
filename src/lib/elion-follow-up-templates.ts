...
const SOFT_CLOSE_HTML = `<p style="margin:20px 0 0;font-size:14px;color:#475569;">Thanks for your time. If you ever see this and it's a fit, we'd love to hear from you. Take care.</p>`;
