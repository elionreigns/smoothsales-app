...
> = {
  "elion-fans-followup-1": {
    ...
    text: "Hi {{Name}},\n\nFollowing up - we would still love for you to hit follow and stream E Lion. 15+ years, Family Feud grand prize, 10M+ YouTube views. One click and you are in: elionmusic.com or your favorite platform." + CONTACT_FOOTER,
    html: box(
      "#1e40af",
      "<p style=\"margin:0 0 18px;font-size:15px;line-height:1.65;\">Following up - we would still love for you to hit follow and stream E Lion. 15+ years, Family Feud grand prize, 10M+ YouTube views.</p><p style=\"margin:0 0 20px;\"><a href=\"https://www.elionmusic.com\" style=\"display:inline-block;background:#1d4ed8;color:#fff;padding:14px 28px;text-decoration:none;border-radius:999px;font-weight:700;\">elionmusic.com</a></p>"
    ),
  },
  "elion-fans-followup-2": {
    subject: "One more nudge - E Lion, Holy Hip-Hop from Hawaii",
    text: "Hi {{Name}},\n\nQuick nudge: E Lion music is on every platform - Spotify, Apple, TikTok, Pandora. First Hawaiian family to win Family Feud. If you have not hit follow yet, one click and you are in. elionmusic.com" + CONTACT_FOOTER,
    html: box(
      "#1e40af",
      "<p style=\"margin:0 0 18px;font-size:15px;line-height:1.65;\">Quick nudge: E Lion music is on every platform - Spotify, Apple, TikTok, Pandora. First Hawaiian family to win Family Feud.</p><p style=\"margin:0 0 20px;\"><a href=\"https://www.elionmusic.com\" style=\"display:inline-block;background:#1d4ed8;color:#fff;padding:14px 28px;text-decoration:none;border-radius:999px;font-weight:700;\">elionmusic.com</a></p>"
    ),
  },
  "elion-fans-followup-3": {
    subject: "Last note - E Lion stream & follow",
    text: "Hi {{Name}},\n\nLast note: if you are into Holy Hip-Hop or island vibes, E Lion is worth a follow. elionmusic.com - no pressure." + SOFT_CLOSE + CONTACT_FOOTER,
    html: box(
      "#1e40af",
      "<p style=\"margin:0 0 18px;font-size:15px;line-height:1.65;\">Last note: if you are into Holy Hip-Hop or island vibes, E Lion is worth a follow. No pressure.</p>" + SOFT_CLOSE_HTML + "<p style=\"margin:16px 0 0;\"><a href=\"https://www.elionmusic.com\" style=\"display:inline-block;background:#1d4ed8;color:#fff;padding:12px 24px;text-decoration:none;border-radius:999px;font-weight:600;\">elionmusic.com</a></p>"
    ),
  },
  "elion-artists-followup-1": {
    subject: "Re: E Lion - Collaboration offer (following up)",
    text: "Hi {{Name}},\n\nFollowing up - E Lion is still open to a free collab (verse, feature, cross-promo). 15+ years, 10M+ views, Family Feud. Reply \"in\" and we will get the details sorted." + CONTACT_FOOTER,
    html: box(
      "#7c3aed",
  ...
  "elion-artists-followup-2": {
    ...
    text: "Hi {{Name}},\n\nQuick nudge: free collaboration, full credit, cross-promo. Family Feud winner, 100+ songs live. Reply \"yes\" or \"tell me more\" and we will make it happen." + CONTACT_FOOTER,
    html: box(
      "#7c3aed",
  ...
  "elion-artists-followup-3": {
    ...
    text: "Hi {{Name}},\n\nLast note: we are still down for a free collab if the timing is right. One reply and we will take it from there." + SOFT_CLOSE + CONTACT_FOOTER,
    html: box(
      "#7c3aed",
      "<p style=\"margin:0 0 18px;font-size:15px;line-height:1.65;\">Last note: we are still down for a free collab if the timing is right. One reply and we will take it from there.</p>" + SOFT_CLOSE_HTML + "<p style=\"margin:16px 0 0;\"><a href=\"https://www.elionmusic.com\" style=\"display:inline-block;background:#6d28d9;color:#fff;padding:12px 24px;text-decoration:none;border-radius:999px;font-weight:600;\">elionmusic.com</a></p>"
    ),
  },
  "elion-brands-followup-1": {
    subject: "Re: E Lion Music - Sponsor partnership (quick follow-up)",
    text: "Hi {{Name}},\n\nFollowing up - E Lion is still open to adding your brand as an official sponsor on elionmusic.com (with a link to your site) in exchange for store credit or gear/apparel. 100+ songs on all platforms, Family Feud reach, 10M+ YouTube views. One reply and we will get the details sorted." + CONTACT_FOOTER,
    html: box(
      "#1e40af",
      "<p style=\"margin:0 0 18px;font-size:15px;line-height:1.65;\">Following up - E Lion is still open to adding your brand as an <strong>official sponsor on elionmusic.com</strong> (with a link to your site) in exchange for store credit or gear/apparel.</p><p style=\"margin:0 0 18px;font-size:14px;\">100+ songs on all platforms, Family Feud reach, 10M+ YouTube views. One reply and we will get the details sorted.</p><p style=\"margin:24px 0 0;\"><a href=\"https://www.elionmusic.com\" style=\"display:inline-block;background:#1d4ed8;color:#fff;padding:14px 28px;text-decoration:none;border-radius:999px;font-weight:700;\">elionmusic.com</a></p>"
    ),
  },
  "elion-brands-followup-2": {
    subject: "One more reason to partner with E Lion (sponsor + link)",
    text: "Hi {{Name}},\n\nQuick nudge: your brand in front of 115M+ Family Feud viewers and an artist with 100+ songs live - we add you as a sponsor with a link, you provide product or credit. No long-term commitment. Reply \"yes\" or \"tell me more\" and we will take it from there." + CONTACT_FOOTER,
    html: box(
      "#1e40af",
  ...
  "elion-brands-followup-3": {
    ...
    text: "Hi {{Name}},\n\nLast note: we are still offering sponsor placement + link on elionmusic.com for product or store credit. If you are open, one quick reply gets you on the page." + SOFT_CLOSE + CONTACT_FOOTER,
    html: box(
      "#1e40af",
      "<p style=\"margin:0 0 18px;font-size:15px;line-height:1.65;\">Last note: we are still offering <strong>sponsor placement + link on elionmusic.com</strong> for product or store credit. If you are open, one quick reply gets you on the page.</p>" + SOFT_CLOSE_HTML + "<p style=\"margin:16px 0 0;\"><a href=\"https://www.elionmusic.com\" style=\"display:inline-block;background:#1d4ed8;color:#fff;padding:12px 24px;text-decoration:none;border-radius:999px;font-weight:600;\">elionmusic.com</a></p>"
    ),
  },
  "elion-producers-followup-1": {
    subject: "Re: E Lion - Beat request (following up)",
    text: "Hi {{Name}},\n\nFollowing up - E Lion would still love exclusive access to your beats. You get full credit on every release and every platform. 15+ years, 10M+ views, Family Feud. Reply and we will get into format and credits." + CONTACT_FOOTER,
    html: box(
      "#ea580c",
  ...
  "elion-producers-followup-2": {
    ...
    text: "Hi {{Name}},\n\nQuick nudge: your name on every release, no ghost credits. Family Feud winner, 100+ songs live. Reply with a link or \"tell me more\" and we will lock it in." + CONTACT_FOOTER,
    html: box(
      "#ea580c",
  ...
  "elion-producers-followup-3": {
    ...
    text: "Hi {{Name}},\n\nLast note: we are still looking for beats for exclusive use with full credit. If the timing is right, one reply and we will get into format and BPM." + SOFT_CLOSE + CONTACT_FOOTER,
    html: box(
      "#ea580c",
      "<p style=\"margin:0 0 18px;font-size:15px;line-height:1.65;\">Last note: we are still looking for beats for exclusive use with full credit. One reply and we will get into format and BPM.</p>" + SOFT_CLOSE_HTML + "<p style=\"margin:16px 0 0;\"><a href=\"https://www.elionmusic.com\" style=\"display:inline-block;background:#c2410c;color:#fff;padding:12px 24px;text-decoration:none;border-radius:999px;font-weight:600;\">elionmusic.com</a></p>"
    ),
  },
  "elion-venue-church-followup-1": {
    subject: "Re: E Lion - Book for your church (following up)",
    text: "Hi {{Name}},\n\nFollowing up - we would still be honored to bring E Lion to your church (concert or keynote, P48X + Prayer Authority). 1,000+ performances, Family Feud grand prize. Reply with a date or \"tell me more\" and we will send a set list and details." + CONTACT_FOOTER,
    html: box(
      "#b45309",
      "<p style=\"margin:0 0 18px;font-size:15px;line-height:1.65;\">Following up - we would still be honored to bring E Lion to your church (concert or keynote, P48X + Prayer Authority). 1,000+ performances, Family Feud grand prize.</p><p style=\"margin:0 0 20px;\"><a href=\"https://www.elionmusic.com\" style=\"display:inline-block;background:#92400e;color:#fff;padding:14px 28px;text-decoration:none;border-radius:999px;font-weight:700;\">elionmusic.com</a></p>"
    ),
  },
  "elion-venue-church-followup-2": {
    subject: "One more reason to book E Lion for your church",
    text: "Hi {{Name}},\n\nQuick nudge: full concert or keynote, custom set list, ministry and music in one package. Waikiki Shell, Blaisdell, HebrewFest, churches nationwide. Reply with your ideal date(s) and we will send credentials and rate." + CONTACT_FOOTER,
    html: box(
      "#b45309",
  ...
  "elion-venue-church-followup-3": {
    ...
    text: "Hi {{Name}},\n\nLast note: E Lion is still available for church events. Reply with a date and we will send a set list and details." + SOFT_CLOSE + CONTACT_FOOTER,
    html: box(
      "#b45309",
      "<p style=\"margin:0 0 18px;font-size:15px;line-height:1.65;\">Last note: E Lion is still available for church events. Reply with a date and we will send a set list and details.</p>" + SOFT_CLOSE_HTML + "<p style=\"margin:16px 0 0;\"><a href=\"https://www.elionmusic.com\" style=\"display:inline-block;background:#92400e;color:#fff;padding:12px 24px;text-decoration:none;border-radius:999px;font-weight:600;\">elionmusic.com</a></p>"
    ),
  },
  "elion-venue-show-followup-1": {
    subject: "Re: E Lion - Book for festival or stage (following up)",
    text: "Hi {{Name}},\n\nFollowing up - E Lion is still available for your festival or stage show. 115M+ Family Feud viewers, 1,000+ performances, Waikiki Shell, Blaisdell. Reply with event name and date(s) and we will send credentials and rate." + CONTACT_FOOTER,
    html: box(
      "#b91c1c",
  ...
  "elion-venue-show-followup-2": {
    ...
    text: "Hi {{Name}},\n\nQuick nudge: full concert, custom set list, artist who can draw and deliver. First Hawaiian family to win Family Feud. Reply with your slot and we will get into rider and rate." + CONTACT_FOOTER,
    html: box(
      "#b91c1c",
  ...
  "elion-venue-show-followup-3": {
    ...
    text: "Hi {{Name}},\n\nLast note: E Lion is still available for festivals and stage shows. Reply and we will send credentials and make it happen." + SOFT_CLOSE + CONTACT_FOOTER,
    html: box(
      "#b91c1c",
      "<p style=\"margin:0 0 18px;font-size:15px;line-height:1.65;\">Last note: E Lion is still available for festivals and stage shows. Reply and we will send credentials and make it happen.</p>" + SOFT_CLOSE_HTML + "<p style=\"margin:16px 0 0;\"><a href=\"https://www.elionmusic.com\" style=\"display:inline-block;background:#991b1b;color:#fff;padding:12px 24px;text-decoration:none;border-radius:999px;font-weight:600;\">elionmusic.com</a></p>"
    ),
  },
  "elion-venue-dj-followup-1": {
    subject: "Re: DJ E Lion for your event (following up)",
    text: "Hi {{Name}},\n\nFollowing up - DJ E Lion is still available for your event. Family-friendly, high-energy, 1,000+ stages. Reply with event type and date(s) and we will get into rate and setup." + CONTACT_FOOTER,
    html: box(
      "#6d28d9",
  ...
  "elion-venue-dj-followup-2": {
    ...
    text: "Hi {{Name}},\n\nQuick nudge: clean set, his own music and more, 15+ years and Family Feud. Reply with duration and what you need (PA, tables) and we will turn it up." + CONTACT_FOOTER,
    html: box(
      "#6d28d9",
  ...
  "elion-venue-dj-followup-3": {
    ...
    text: "Hi {{Name}},\n\nLast note: DJ E Lion is still available if you have a date. One reply and we will get into rate and setup." + SOFT_CLOSE + CONTACT_FOOTER,
    html: box(
      "#6d28d9",
      "<p style=\"margin:0 0 18px;font-size:15px;line-height:1.65;\">Last note: DJ E Lion is still available if you have a date. One reply and we will get into rate and setup.</p>" + SOFT_CLOSE_HTML + "<p style=\"margin:16px 0 0;\"><a href=\"https://www.elionmusic.com\" style=\"display:inline-block;background:#5b21b6;color:#fff;padding:12px 24px;text-decoration:none;border-radius:999px;font-weight:600;\">elionmusic.com</a></p>"
    ),
  },
  "elion-venue-major-followup-1": {
    subject: "Re: E Lion - Opening for major artists (following up)",
    text: "Hi {{Name}},\n\nFollowing up - E Lion is still interested in opening slots at your venue when you host major artists. Waikiki Shell, Blaisdell experience; full set, professional rider. Reply if you have or expect opening slots and we will send credentials." + CONTACT_FOOTER,
    html: box(
      "#15803d",
  ...
  "elion-venue-major-followup-2": {
    ...
    text: "Hi {{Name}},\n\nQuick nudge: 15+ years, 1,000+ performances, Family Feud grand prize. Already played Waikiki Shell and Blaisdell. If you have opening slots for local/regional artists, reply and we will send a set list and stay in touch." + CONTACT_FOOTER,
    html: box(
      "#15803d",
  ...
  "elion-venue-major-followup-3": {
    ...
    text: "Hi {{Name}},\n\nLast note: E Lion is still interested in opening for major artists at your venue when the right slot comes up. Reply anytime and we will send credentials." + SOFT_CLOSE + CONTACT_FOOTER,
    html: box(
      "#15803d",
      "<p style=\"margin:0 0 18px;font-size:15px;line-height:1.65;\">Last note: E Lion is still interested in opening when the right slot comes up. Reply anytime and we will send credentials.</p>" + SOFT_CLOSE_HTML + "<p style=\"margin:16px 0 0;\"><a href=\"https://www.elionmusic.com\" style=\"display:inline-block;background:#166534;color:#fff;padding:12px 24px;text-decoration:none;border-radius:999px;font-weight:600;\">elionmusic.com</a></p>"
    ),
  },
};
