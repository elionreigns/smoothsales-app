...
function ElionContent({ audience }: { audience: ElionSub }) {
  return (
    <div className="prose prose-invert prose-sm max-w-none text-slate-300">
      ...
      {audience === "leaders" && (
        <p><strong>Leaders template:</strong> Full ministry + life update for pastors and organization leaders with P48X book/audiobook links, Prayer Authority tools, HOPE Weekends, photo stories, social-share buttons, and a clear venue offer (concert/keynote/book table + QR signup demo + custom setlist via player/promo).</p>
      )}
      {audience === "laymen" && (
        <p><strong>Laymen template:</strong> Personal update for friends/supporters with stronger calls-to-action: buy P48X on Apple Books, get the audiobook, follow Spotify + Apple Music, sign up on PrayerAuthority, and share the press kit with leaders.</p>
      )}
      <p>Stream: <a href="https://open.spotify.com/artist/2S3rAhbq65ECikmOW1k2EA" target="_blank" rel="noreferrer" className="text-amber-400 hover:text-amber-300">Spotify</a>, <a href="https://music.apple.com/us/artist/e-lion/1111804063" target="_blank" rel="noreferrer" className="text-amber-400 hover:text-amber-300">Apple Music</a>, <a href="https://www.amazon.com/music/player/artists/B01GOGAW4W/e-lion" target="_blank" rel="noreferrer" className="text-amber-400 hover:text-amber-300">Amazon Music</a>, <a href="https://www.tiktok.com/@elionreigns" target="_blank" rel="noreferrer" className="text-amber-400 hover:text-amber-300">TikTok</a>, <a href="https://www.elionmusic.com/presskit/" target="_blank" rel="noreferrer" className="text-amber-400 hover:text-amber-300">Press kit</a>, <a href="https://www.elionmusic.com/player/" target="_blank" rel="noreferrer" className="text-amber-400 hover:text-amber-300">Player</a>, <a href="https://www.elionmusic.com/promo/" target="_blank" rel="noreferrer" className="text-amber-400 hover:text-amber-300">Promo songs</a>, <a href="https://www.elionmusic.com" target="_blank" rel="noreferrer" className="text-amber-400 hover:text-amber-300">elionmusic.com</a></p>
    </div>
  );
}
